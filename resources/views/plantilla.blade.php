...
<head>
    ...
    <!-- Bootstrap 3.3.7 -->
    <link rel="stylesheet"
        href="http://localhost/clinica/public/bower_components/bootstrap/dist/css/bootstrap.min.css">
    <!-- Font Awesome -->
    <link rel="stylesheet"
        href="http://localhost/clinica/public/bower_components/font-awesome/css/font-awesome.min.css">
    <!-- Ionicons -->
    ...
    <!-- jvectormap -->
    <link rel="stylesheet"
        href="http://localhost/clinica/public/bower_components/jvectormap/jquery-jvectormap.css">
    <!-- Date Picker -->
    <link rel="stylesheet"
        href="http://localhost/clinica/public/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
    <!-- Daterange picker -->
    <link rel="stylesheet"
        href="http://localhost/clinica/public/bower_components/bootstrap-daterangepicker/daterangepicker.css">
...
<body class="hold-transition skin-blue sidebar-mini login-page">
    ...
    <script
        src="http://localhost/clinica/public/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
    <!-- datepicker -->
    <script
        src="http://localhost/clinica/public/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
    <!-- Slimscroll -->
    ...
    <script src="http://localhost/clinica/public/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
